...
function useValidation(props) {
  ...
  const vm = getCurrentInstance2("validation");
...
var itemTypes$1 = /* @__PURE__ */ new Set(["item", "divider", "subheader"]);
...
var VOverlay = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    const vm = getCurrentInstance2("VOverlay");
    const root = ref();
    const scrimEl = ref();
    const contentEl = ref();
    const model = useProxiedModel(props, "modelValue");
    ...
    useRender(() => {
      ...
      return createVNode(VTextField, mergeProps({
        ...
        default: () => createBaseVNode(Fragment, null, [createVNode(VMenu, mergeProps({
          ...
          }, [item.title, props.multiple && index2 < model.value.length - 1 && createBaseVNode("span", {
    ...
    useRender(() => {
      ...
      return createVNode(VTextField, mergeProps({
        ...
        default: () => createBaseVNode(Fragment, null, [createVNode(VMenu, mergeProps({
          ...
          return createBaseVNode("div", {
            "key": item.value,
            "class": normalizeClass(["v-autocomplete__selection", index2 === selectionIndex.value && ["v-autocomplete__selection--selected", textColorClasses.value]]),
            "style": normalizeStyle(index2 === selectionIndex.value ? textColorStyles.value : {})
    ...
    useRender(() => {
      ...
      return createVNode(VTextField, mergeProps({
        ...
        default: () => createBaseVNode(Fragment, null, [createVNode(VMenu, mergeProps({
          ...
          return createBaseVNode("div", {
            "key": item.value,
            "class": normalizeClass(["v-combobox__selection", index2 === selectionIndex.value && ["v-combobox__selection--selected", textColorClasses.value]]),
            "style": normalizeStyle(index2 === selectionIndex.value ? textColorStyles.value : {})
          }, [hasChips.value ? !slots.chip ? createVNode(VChip, mergeProps({
            "key": "chip",
            "closable": props.closableChips,
  ...
  setup(props, _ref) {
    ...
    useRender(() => createVNode(props.tag, {
      ...
      default: () => [createBaseVNode("ul", {
        ...
        "_as": "VPaginationBtn"
      }, controls.value.prev), null)]), items.value.map((item, index2) => createBaseVNode("li", {
        "key": item.key,
...
var VDataTableRows = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    useRender(() => {
      ...
      return createBaseVNode(Fragment, null, [props.items.map((item, index2) => {
        if (item.type === "group") {
          const slotProps2 = {
            index: index2,
            item,
  ...
  function genDays(days, today) {
    return days.filter((date2) => {
      ...
      return {
        ...
        isWeekEnd: index2 % weekdaysCount === weekdaysCount - 1,
        isWeekStart: index2 % weekdaysCount === 0,
        isoDate,
...
var VOtpInput = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    function onPaste(index2, e) {
      ...
      const finalIndex = clipboardText.length - 1 === -1 ? index2 : clipboardText.length - 1;
...
var VBarline = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    useRender(() => {
      ...
      }, [gradientData.map((color, index2) => createBaseVNode("stop", {
      ...
      return createVNode(VSheet, mergeProps(sheetProps, {
        ...
        default: () => [hasHeader && createVNode(VStepperHeader, {
          ...
          default: () => [items.value.map((_ref2, index2) => {
            ...
            return createBaseVNode(Fragment, null, [!!index2 && createVNode(VDivider, null, null), createVNode(VStepperItem, item, {
...
var VTreeviewChildren = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    return () => slots.default?.() ?? props.items?.map((item, index2, items) => {
      const {
        children,
        props: itemProps
      } = item;
      const loading = isLoading.has(item.value);
      const nextItemHasChildren = !!items.at(index2 + 1)?.children;
      const depth = props.path?.length ?? 0;
      const isLast = items.length - 1 === index2;
      const treeItemProps = {
        index: index2,
        depth,
        isFirst: index2 === 0,
        isLast,
        path: [...props.path, index2],
      ...
      return children ? createVNode(VTreeviewGroup, mergeProps(treeviewGroupProps, {
        ...
        activator: (_ref2) => {
          ...
          const listItemProps = {
            ...
            onClick: isClickOnOpen.value ? [() => checkChildren(item), activatorProps.onClick] : () => selectItem(activatorItems.value[index2]?.select, !activatorItems.value[index2]?.isSelected)
          };
          return createVNode(VTreeviewItem, mergeProps({
            "ref": (el) => activatorItems.value[index2] = el
          }, listItemProps, {
...
vuetify/dist/vuetify.esm.js:
  ...
  *)
*/
//# sourceMappingURL=vuetify_dist_vuetify__js.js.map
